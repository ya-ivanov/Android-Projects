	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		colorHex.setOnLongClickListener(new OnLongClickListener() {
			...
			public boolean onLongClick(View arg0) {
				...
				ClipData clip = ClipData.newPlainText("Copy Color", "#" + curHex);
				clipboard.setPrimaryClip(clip);
				Toast.makeText(getApplicationContext(), "Color #" + curHex + " is now in your clipboard.", Toast.LENGTH_SHORT).show();
				return false;
			}
		...
		OnTouchListener imgSourceOnTouchListener = new OnTouchListener() {
			...
			public boolean onTouch(View view, MotionEvent event) {
				...
				if (String.valueOf(Integer.toHexString(touchedRGB)).length() > 2)
				{
					...
					curHex = String.valueOf(Integer.toHexString(touchedRGB)).substring(2);
				}
